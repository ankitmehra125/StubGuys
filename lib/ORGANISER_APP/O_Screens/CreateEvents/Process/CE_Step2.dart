    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return Dialog(
          ...
          insetPadding: EdgeInsets.all(20), // Adjust inset padding as needed
          child: Container(
            width: MediaQuery.of(context).size.width,
            height: MediaQuery.of(context).size.height*0.7,// Make container full width
            child: TableCalendar(
              focusedDay: DateTime.now(),
              firstDay: DateTime.now(),
              lastDay: DateTime.now(),
              calendarStyle: CalendarStyle(
                // Optionally, adjust calendar style as needed
